...
<!--formValidation-->
<script type="text/javascript"
	src="app/lib/formValidation/js/formValidation.min.js"></script>
<!--formValidation bootstrap-->
<script type="text/javascript"
	src="app/lib/formValidation/js/framework/bootstrap.min.js"></script>
<!--lodash-->
...
<!--bootstrap-select-->
<script type="text/javascript"
	src="app/bower_components/bootstrap-select/dist/js/bootstrap-select.js"></script>
<!--lodash-->
<script type="text/javascript"
...
<!--jquery nicescroll-->
<script type="text/javascript"
	src="app/bower_components/jquery.nicescroll/dist/jquery.nicescroll.min.js"></script>
...
<!--A3纸张答题卡配置参数-->
<script type="text/javascript"
	src="app/script/config/defaultSetting-a3.js"></script>
<!--A4纸张答题卡配置参数-->
<script type="text/javascript"
...
<!--当前使用的纸张答题卡配置参数-->
<script type="text/javascript"
	src="app/script/config/defaultSetting.js"></script>

<!--自定义js库-->
<script type="text/javascript" src="app/script/utils/uiBuilder.js"></script>
<script type="text/javascript" src="app/script/utils/uiwrapper.js"></script>
...
<script type="text/javascript" src="app/script/elements/anchorPoint.js"></script>
...
<!--加载元素控件创建弹出框-->
<script type="text/javascript" src="app/script/dialog/settingDialog.js"></script>
